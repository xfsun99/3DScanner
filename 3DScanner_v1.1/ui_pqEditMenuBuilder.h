...
**
** Created: Tue Dec 16 12:25:13 2014
...
public:
    ...
    QAction *actionEditViewSettings;
    ...
    void setupUi(QMenu *pqEditMenuBuilder)
    {
        ...
        actionEditViewSettings = new QAction(pqEditMenuBuilder);
        actionEditViewSettings->setObjectName(QString::fromUtf8("actionEditViewSettings"));
        ...
        pqEditMenuBuilder->addAction(actionEditViewSettings);
    ...
    void retranslateUi(QMenu *pqEditMenuBuilder)
    {
...
#endif // QT_NO_STATUSTIP
        actionDelete_All->setText(QApplication::translate("pqEditMenuBuilder", "Delete All", 0, QApplication::UnicodeUTF8));
        ...
        actionEditViewSettings->setText(QApplication::translate("pqEditMenuBuilder", "View Settings...", 0, QApplication::UnicodeUTF8));
